...
<div class="fieldcontain ${hasErrors(bean: addressInstance, field: 'city', 'error')} required">
	...
	<g:select id="city" name="city.id" from="${com.org.City.list()}" optionKey="id" required="" value="${addressInstance?.city?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: addressInstance, field: 'country', 'error')} required">
	...
	<g:select id="country" name="country.id" from="${com.org.Country.list()}" optionKey="id" required="" value="${addressInstance?.country?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: addressInstance, field: 'pincode', 'error')} required">
	...
	<g:field name="pincode" type="number" value="${addressInstance.pincode}" required=""/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: addressInstance, field: 'state', 'error')} required">
	...
	<g:select id="state" name="state.id" from="${com.org.State.list()}" optionKey="id" required="" value="${addressInstance?.state?.id}" class="many-to-one"/>
</div>
